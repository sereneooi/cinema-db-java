...
<%
    ...
    if(request.getAttribute("questionObj") != null) {
        questionObj = (Question) request.getAttribute("questionObj");
    } 
%>
...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            <form method="post" action="UpdateQuestionController">
                <div>
                    <div class="form-group focused">
                        <label class="form-label" for="questionID">QuestionID</label>              
                        <input name="questionID" class="form-input" type="text" value="<%= questionObj.getQuestionID() %>" readonly />
                        <span class="form-input-required">*</span>
                    </div>

                    <div class="form-group focused">
                        <label class="form-label" for="question">Question</label>
                        <input name="question" class="form-input" type="text" value="<%= questionObj.getQuestion() %>" maxlength="100" autocomplete="off" required />
                        <span class="form-input-required">*</span>
                    </div>
