    ...
    <body>
         <%@include file="AdminLayout.jsp"%>
              ...
              <%       //get Object from Servlet
                         ...
                         searchedMovie =(Movie) session.getAttribute("specificNsMovie");
                %>
                ...
                <div class="row">
                  ...
                  <div class="col">
                      <table style="width:500; table-layout: fixed;">
                            ...
                            <tr>
                              <td width="2%"><%= searchedMovie.getMovieID() %></td>
                              <td width="2%"><%= searchedMovie.getMovieName() %></td>
                              <td width="6%"><img style="height: 230px; width: 160px;" src="<%= searchedMovie.getMoviePoster() %>"></td>
                              <td width="10%" style="text-align:center;">
                                    <%
                                            ...
                                            showtimesList = movieScheduleDA.displayShowtimeRecord(searchedMovie.getMovieID());
                                    %>       
                              ...
                              <td width="10%"><form action="updateSchedule.jsp" method="post">
                                                           ...
                                                           <form action="deleteSchedule.jsp" method="post">
                                                                        ...
                                                                        <input type="hidden"  name="movieNameforDelete"  value="<%= searchedMovie.getMovieName() %>">
