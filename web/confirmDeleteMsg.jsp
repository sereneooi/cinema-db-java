    ...
    <body>
                ...
                <div class="row">
                     ...
                     <% 
                         ...
                         String movieShowtimes =  request.getParameter("showtimeToRetrieve");
                       %>
                    ...
                    <h1 style="text-align: center; font-family: 'mahelisa'; font-size: 25px; color:white; letter-spacing: 8px; font-size: 45px; margin-top: -27px; margin-bottom: 5px;">CONFIRM DELETE ?</h1><br/>
                        ...
                        <button onclick="location.href='AdminMovieSchedule.jsp'" class="button" type="button" >No</button>
                    
                        <form action="ConfirmedToDelete" method="get" style="margin-top: -34px;">
                                          <input type="hidden"  name="movieScheduleIDforDelete"  value="<%= movieScheduleID %>">
                                          <input type="hidden"  name="movieNameforDelete"  value="<%= movieName %>">
                                          <input type="hidden"  name="movieShowtimeForDelete"  value="<%= movieShowtimes %>">
