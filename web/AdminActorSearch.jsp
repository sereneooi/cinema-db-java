        ...
        <%@include file="AdminLayout.jsp"%>
              ...
              <% 
                       //get Object from Servlet
                         Actor searchedActor = new Actor();
                         searchedActor =(Actor) session.getAttribute("specificActor");
               %>
                ...
                <div class="row">
                  ...
                  <div class="col">
                    ...
                    <p style="text-align: right; padding-right: 85px;">Record Fetched: <%= "1" %> row</p><br/>
                  <div class="col">
                      <table style="width:300; table-layout: fixed;">
                            ...
                            <tr>
                              <td><%= searchedActor.getActorID() %></td>
                              <td><%= searchedActor.getActorName()%></td>
                              <td style="margin-left: 50px;">
                                  <form action="updateActor.jsp" method="post">
                                                                         <input type="hidden"  name="actorIDforUpdate"  value="<%= searchedActor.getActorID() %>">
                                                                         <input type="hidden"  name="actorNameforUpdate"  value="<%= searchedActor.getActorName() %>">
                                                                         <input type="submit" class="actionBtn"value="Update"><br/>
                                  </form>
                                                           
                                  <form action="confirmActorDeleteMsg.jsp" method="post">
                                                                        <input type="hidden"  name="actorIDforDelete"  value="<%= searchedActor.getActorID() %>">
