        ...
        <%@include file="AdminLayout.jsp"%>
              ...
              <% 
                       //get Object from Servlet
                         ...
                         searchedMovie =(Movie) session.getAttribute("specificMovie");
               %>
                ...
                <div class="row">
                  ...
                  <div class="col">
                    ...
                    <p style="text-align: right; padding-right: 5px;">Record Fetched: <%= "1" %> row </p><br/>
                  <div class="col">
                      <table style="width:500; table-layout: fixed;">
                            ...
                            <tr>
                              <td><%= searchedMovie.getMovieID() %></td>
                              <td><%= searchedMovie.getMovieName() %></td>
                              <td><img style="height: 170px; width: 120px;" src="<%= searchedMovie.getMoviePoster() %>"></td>
                              <td>
                                  <!--Display Actor Name List -->
                               <% CastListDA castlistDA = new CastListDA();
                                ArrayList<CastList> actorList = new ArrayList<CastList>();
                                actorList = castlistDA.getCastListRecord(searchedMovie.getMovieID()); 
                              ...
                              <td><%= searchedMovie.getMovieType().getMovieTypeDesc() %></td>
                              <td><%= searchedMovie.getMovieStatus().getMovieStatusDesc() %></td>
                              <td><%= searchedMovie.getLanguage().getLanguageDesc() %></td>
                              <td><form action="GetUpdatedMovie" method="post">
                                                                         <input type="hidden"  name="movieIDforUpdate"  value="<%= searchedMovie.getMovieID() %>">
                                                                         <input type="hidden"  name="movieNameforUpdate"  value="<%= searchedMovie.getMovieName() %>">
                                                                         <input type="hidden"  name="movieTrailerforUpdate"  value="<%= searchedMovie.getMovieTrailer() %>">
                                                                         <input type="hidden"  name="posterURLforUpdate"  value="<%= searchedMovie.getMoviePoster() %>">
                                                                         <input type="hidden"  name="adsURLforUpdate"  value="<%= searchedMovie.getMovieAdsPoster() %>">
                                                                         <input type="hidden"  name="synopsisForUpdate"  value="<%= searchedMovie.getSynopsis() %>">
                                                                         <input type="submit" class="actionBtn"value="Update"><br/>
                                                           </form>
                                                           <form action="MovieRetrieve" method="get">
                                                                       <input type="hidden"  name="movieIDforRetrieve"  value="<%= searchedMovie.getMovieID() %>">
                                                                       <input type="submit" class="actionBtn"value="View"><br/>
                                                           </form>
                                                           <form action="confirmMovieDeleteMsg.jsp" method="post">
                                                                        <input type="hidden"  name="movieIDforDelete"  value="<%= searchedMovie.getMovieID() %>">
