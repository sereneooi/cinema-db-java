    ...
    <body>
        ...
        %>
                ...
                <div class="row">
                     ...
                     <% 
                         String actorID =  request.getParameter("actorIDforDelete");
                       %>
                    ...
                    <h1 style="text-align: center; font-family: 'mahelisa'; font-size: 25px; color:white; letter-spacing: 8px; font-size: 45px; margin-top: -27px; margin-bottom: 5px;">CONFIRM DELETE ?</h1><br/>
                        ...
                        <button onclick="location.href='AdminActorList.jsp'" class="button" type="button" >No</button>
                    
                        <form action="ActorDelete" method="get" style="margin-top: -34px;">
                                          <input type="hidden"  name="actorIDforDeletion"  value="<%= actorID %>">
