...
<html>
    ...
    <body>
                <div class="contentContainer1">
                    ...
                    <% String retrievedMsg = (String)session.getAttribute("failedErorMsg"); 
                ...
                <div class="row">
                 <div class="col1">
                    ...
                    <img style="height: 185px; width: 185px; margin: 28px 10px 40px 365px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Cross_red_circle.svg/1024px-Cross_red_circle.svg.png" /><br/>
                    <h1 style="text-align: center; font-family: 'mahelisa'; font-size: 25px; color:white; letter-spacing: 8px; font-size: 45px; margin-top: -27px;">ERROR</h1><br/>
