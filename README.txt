...
|                                        | Staff  | View ALL         |
+----------------------------------------+--------+------------------+
| Food & Beverages Order Delivery        | Admin, | View ALL         |
|                                        | Staff  +------------------+
|                                        |        | Update           |
+----------------------------------------+--------+------------------+
| Promotion                              | Admin, | Add              |
...
|                                        |        | View ALL         |
+----------------------------------------+--------+------------------+
| Top Favourite Food & Beverages Report, | Admin, |                  |
| Service Rating Report                  | Staff  | View             |
|                                        |        |                  |
+----------------------------------------+--------+------------------+
| Daily Sales Report,                    | Admin  | View             |
| Top List of Highest Grossing Report    +--------+------------------+
|                                        | Staff  | -                |
+----------------------------------------+--------+------------------+
