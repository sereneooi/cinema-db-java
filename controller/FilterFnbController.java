...
@WebServlet(name = "FilterFnbController", urlPatterns = {"/FilterFnbController"})
public class FilterFnbController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Fnb> filterFnbList = fnbDA.filterFnb(keyword);
