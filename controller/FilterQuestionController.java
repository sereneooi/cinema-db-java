...
@WebServlet(name = "FilterQuestionController", urlPatterns = {"/FilterQuestionController"})
public class FilterQuestionController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Question> filterQuestionList = questionDA.filterQuestion(keyword);
            
            request.setAttribute("filterQuestionList", filterQuestionList);
