...
@WebServlet(name = "UpdateActor", urlPatterns = {"/UpdateActor"})
public class UpdateActor extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String actorID = request.getParameter("actorIDToUpdate");
        String actorName = request.getParameter("actorNameToUpdate");
        ...
        try{
               ...
               actorDA.updateActor(actor);
    
               //pass msg to display it out in successful message
               String successfulMsg = "Actor ID " + actorID + " has been updated to the database.";
